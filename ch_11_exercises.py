...
class Dwelling:
    def __init__(self, number_of_rooms, square_ft, floors):
...
class SingleFamilyHome(Dwelling):
    def __init__(self, number_of_rooms, square_ft, floors, garage_type, yard_size):
        Dwelling.__init__(self, square_ft, number_of_rooms, floors)
...
def main():
    home = SingleFamilyHome('6 rooms', '1200 square ft', '1 floor', 'Single car garage', '.25 acres')
    print('\nRooms: ', home.get_number_of_rooms())
    print('Floors: ', home.get_floors())
    print('Square Feet: ', home.get_square_ft())
